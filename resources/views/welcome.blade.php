...
-->
    <div
        ...
        <img src="https://static.vecteezy.com/system/resources/thumbnails/050/530/110/small/coffee-cups-with-heart-shaped-candies-on-pastel-background-copyspace-playful-loving-theme-copy-space-advertising-image-romantic-setup-valentines-style-mock-up-productrealistic-photo.jpg"
        ...
        <div class="relative z-20 max-w-screen-lg mx-auto grid grid-cols-12 h-full items-center">
            <div class="col-span-6">
                ...
                <h1 class="text-white font-extrabold text-5xl mb-8">
                    "Sweetening Your Day, One Bite at a Time!"
                </h1>
